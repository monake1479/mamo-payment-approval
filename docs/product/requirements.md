...
- `DELIVERY-03`: The settings screen has an About section that summarises what the app does, what was delivered, and the known limitations, and shows the installed version, build number, environment, package identifier, and whether device authentication is available. It is read-only, never starts authentication, and adds no licences page. Coordinator-requested under delegated authority on 2026-09-21; see [ADR 0014](../decisions/0014-about-section-and-package-info.md).
