...
Status: implemented on the feature branch as the slice-5 extension selected from the [backlog](../product/extension-backlog.md) (`SEARCH-01..07`, `PAY-05`); decision recorded in [ADR 0013](../decisions/0013-event-driven-bloc-for-payments-search.md).
