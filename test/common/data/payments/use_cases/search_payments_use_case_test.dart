...
void main() {
  group('SearchPaymentsUseCase', () {
    test('trims the query, forwards statuses and the history sort', () async {
      ...
      final StubPaymentsRepository repository = StubPaymentsRepository(
        ...
        onSearch:
            (
              ...
              PaymentsSort sort,
            ) async => Success<PaymentsFailure, List<Payment>>(<Payment>[
              older,
              newest,
              tieLater,
            ]),
      ...
      expect(repository.searchSorts, <PaymentsSort>[
        PaymentsSort.decidedAtNewestFirst,
      ]);
      // The backend owns ordering; the use case returns it untouched.
      ...
      final StubPaymentsRepository repository = StubPaymentsRepository(
        ...
        onSearch:
            (
              ...
              Set<PaymentStatus> statuses,
              PaymentsSort sort,
            ) async => const Failure<PaymentsFailure, List<Payment>>(
