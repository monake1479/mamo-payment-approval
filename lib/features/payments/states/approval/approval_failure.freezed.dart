...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( DeviceAuthenticationFailure reason)?  authentication,TResult Function( PaymentsFailure failure)?  decision,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ApprovalAuthenticationError() when authentication != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( DeviceAuthenticationFailure reason)  authentication,required TResult Function( PaymentsFailure failure)  decision,}) {final _that = this;
switch (_that) {
case ApprovalAuthenticationError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( DeviceAuthenticationFailure reason)?  authentication,TResult? Function( PaymentsFailure failure)?  decision,}) {final _that = this;
switch (_that) {
case ApprovalAuthenticationError() when authentication != null:
return authentication(_that.reason);case ApprovalDecisionError() when decision != null:
return decision(_that.failure);case _:
...
class ApprovalAuthenticationError implements ApprovalFailure {
 ...
 final  DeviceAuthenticationFailure reason;
...
$DeviceAuthenticationFailureCopyWith<$Res> get reason;
...
as DeviceAuthenticationFailure,
  ));
}
...
$DeviceAuthenticationFailureCopyWith<$Res> get reason {
  ...
  return $DeviceAuthenticationFailureCopyWith<$Res>(_self.reason, (value) {
